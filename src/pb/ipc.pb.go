...
var file_ipc_proto_rawDesc = []byte{
	...
	0x4e, 0x43, 0x4f, 0x4e, 0x46, 0x49, 0x52, 0x4d, 0x45, 0x44, 0x10, 0x04, 0x32, 0xc9, 0x06, 0x0a,
	...
	0x4d, 0x6e, 0x65, 0x6d, 0x6f, 0x6e, 0x69, 0x63, 0x12, 0x3e, 0x0a, 0x15, 0x46, 0x6f, 0x72, 0x63,
	0x65, 0x52, 0x65, 0x73, 0x63, 0x61, 0x6e, 0x46, 0x72, 0x6f, 0x6d, 0x48, 0x65, 0x69, 0x67, 0x68,
	0x74, 0x12, 0x12, 0x2e, 0x69, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x73, 0x63, 0x61, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x69, 0x70, 0x63, 0x2e, 0x42, 0x6f, 0x6f, 0x6c,
...
var file_ipc_proto_depIdxs = []int32{
	...
	10, // 16: ipc.IpcService.BroadcastRawTx:input_type -> ipc.RawTransaction
	2,  // 17: ipc.IpcService.GetMnemonic:input_type -> ipc.Empty
	16, // 18: ipc.IpcService.SetMnemonic:input_type -> ipc.Mnemonic
	17, // 19: ipc.IpcService.CreateNewWallet:input_type -> ipc.NewWalletRequest
	18, // 20: ipc.IpcService.ForceRescanFromHeight:input_type -> ipc.RescanRequest
	3,  // 21: ipc.IpcService.Status:output_type -> ipc.StatusResponse
	15, // 22: ipc.IpcService.SyncHeight:output_type -> ipc.SyncHeightResponse
	6,  // 23: ipc.IpcService.Unlock:output_type -> ipc.BoolResponse
	6,  // 24: ipc.IpcService.SetPassword:output_type -> ipc.BoolResponse
	6,  // 25: ipc.IpcService.Shutdown:output_type -> ipc.BoolResponse
	4,  // 26: ipc.IpcService.ListUTXOs:output_type -> ipc.UTXOCollection
	12, // 27: ipc.IpcService.ListAddresses:output_type -> ipc.AddressesCollection
	13, // 28: ipc.IpcService.CreateNewLabel:output_type -> ipc.Address
	10, // 29: ipc.IpcService.CreateTransaction:output_type -> ipc.RawTransaction
	11, // 30: ipc.IpcService.CreateTransactionAndBroadcast:output_type -> ipc.NewTransaction
	11, // 31: ipc.IpcService.BroadcastRawTx:output_type -> ipc.NewTransaction
	16, // 32: ipc.IpcService.GetMnemonic:output_type -> ipc.Mnemonic
	6,  // 33: ipc.IpcService.SetMnemonic:output_type -> ipc.BoolResponse
	16, // 34: ipc.IpcService.CreateNewWallet:output_type -> ipc.Mnemonic
	6,  // 35: ipc.IpcService.ForceRescanFromHeight:output_type -> ipc.BoolResponse
